namespace DockerTemplate.IntegrationTest.Controllers
{
    using System;
    ...
    using DockerTemplate.IntegrationTest.Fixtures;
    ...
    public class CarsControllerTest : CustomWebApplicationFactory<Startup>
    {
        ...
        public async Task GetPage_FirstPage_Returns200OkAsync(string path)
        {
            ...
            await this.AssertPageUrlsAsync(
                    response,
                    nextPageUrl: "https://localhost/cars?First=3&After=MjAyMC0wOS0wNlQyMTowMzowNy4xMzgzODg4KzAwOjAw",
        ...
        public async Task GetPage_LastPage_Returns200OkAsync(string path)
        {
            ...
            await this.AssertPageUrlsAsync(
                    response,
                    nextPageUrl: null,
                    previousPageUrl: "https://localhost/cars?Last=3&Before=MjAyMC0wOS0wOFQyMTowMzowNy41NzQyMDY2KzAwOjAw")
                .ConfigureAwait(false);
        }
        ...
        public async Task GetPage_SecondLastPage_Returns200OkAsync()
        {
            ...
            var response = await this.client
                .GetAsync(new Uri("/cars?last=3&before=MjAyMC0wOS0wOFQyMTowMzowNy41NzQyMDY2KzAwOjAw", UriKind.Relative))
                .ConfigureAwait(false);
